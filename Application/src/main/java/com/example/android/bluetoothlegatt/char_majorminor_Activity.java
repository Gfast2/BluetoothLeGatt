...
public class char_majorminor_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        majorMinor = getIntent().getStringExtra(DeviceControlActivity.EXTRA_READ);
//        Log.d(TAG, "receive Intent data (majorMinor): " + majorMinor);
        ...
        etMajor.setText("Faked Major value: 101", TextView.BufferType.EDITABLE);
        etMinor.setText("Faked Minor value: 12", TextView.BufferType.EDITABLE);
        etMajor.setText(majorMinor, TextView.BufferType.EDITABLE);
